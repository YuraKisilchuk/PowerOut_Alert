...
const EditArea = () => {
  ...
  const onSubmitFormik = async (values: IEditArea) => {
    try {
     
      const result = await http.put("/api/areas", values);
